...
programRouter.get('/', asyncHandler(async (req, res) => {
  const program = await db.query(`SELECT * FROM program`);
  res.status(200).json(keysToCamel(program));
}));

programRouter.get('/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/:id/enrollment-aggregates', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/students/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/region/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/city/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/state/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/get-program-name/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.delete('/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/:id/regional-directors', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/:id/playlists', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.post('/:id/playlists', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/:id/instruments', asyncHandler(async (req, res) => {
  const { id } = req.params;
  ...
  const rows = await db.query(
    ...
    WHERE p.id = $1 AND (pu.show_on_table = FALSE OR pu.resolved = TRUE)
...
programRouter.get('/:id/program-directors', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/:id/media', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
programRouter.get('/:id/partner-organization', asyncHandler(async (req, res) => {
  const { id } = req.params;
